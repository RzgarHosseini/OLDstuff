# CCSynergy
In the Codes folder, you can find four versions of the CCSynergy program that includes codes for both CV1 and CV2 cross validation schemes and also for both regression and classification settings.
